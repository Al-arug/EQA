...
\subsubsection{Class 1 Method 2 - Annotations from Habitat's sensors}
...
size\_room:'how big \qdist{AUX}  the \qdist{OBJ} in the \qdist{ROOM}?'
...
'\qdist{ AUX} there \qdist{ARTICLE} \qdist{OBJ1} close to the \qdist{OBJ} in the \qdist{ROOM}?'\\
'\qdist{AUX} there \qdist{ARTICLE}  \qdist{OBJ1} next to the \qdist{OBJ} in the \qdist{ROOM}?' \\
'\qdist{AUX}  there \qdist{ARTICLE} \qdist{OBJ1} on the \qdist{OBJ} in the \qdist{ROOM}?\\
'\qdist{AUX} there \qdist{ARTICLE} \qdist{OBJ1} close to the \qdist{OBJ}?',\\
'\qdist{AUX}  there \qdist{ARTICLE} \qdist{OBJ1} next to the \qdist{OBJ} ?',\\
'\qdist{AUX}  there \qdist{ARTICLE} \qdist{OBJ1} on the \qdist{OBJ}?'
